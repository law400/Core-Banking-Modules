<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DropTest.aspx.vb" Inherits="DropTest" %>
...
<body>
   ...
   <%-- <telerik:RadComboBox ID="RadComboBox2" runat="server" Width="250px" Height="150px"
        ...
        DataSourceID="SqlDataSource1" DataTextField="Accounttitle" DataValueField="AccountNumber"
...
<%-- <asp:LinqDataSource runat="server" ID="LinqDataSource1" ContextTypeName="LinqToSql.NorthwindDataContext"
 OrderBy="Accounttitle" Select="new (Accounttitle,AccounNumber)" TableName="tbl_casaaccount">
         ...
         <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString="<%$ ConnectionStrings:Prime %>"
                ProviderName="System.Data.SqlClient" SelectCommand="SELECT [AccountNumber],[Accounttitle] from [tbl_casaaccount] ORDER By [Accounttitle ]" />
