...
"use strict"; 
        ...
        $("form:not(.pix_paypal)").live( "submit", function( event ) {
            ...
            {   
                ...
                $.post('pix_mail/new_contact.html', values, function(response){  
        ...
        $("fieldset #subscribe_btn_1").click(function() { 
            ...
            if(proceed) 
            {
                ...
                //Ajax post data to server
                $.post('pix_mail/contact_me_1.html', post_data, function(response){  
         ...
         $("fieldset #subscribe_btn_2").click(function() { 
           ...
           //$.fancybox("#hidden_pix_2");
            ...
            if(proceed) 
            {
                ...
                //Ajax post data to server
                $.post('pix_mail/contact_me_2.html', post_data, function(response){  
                    //load json data from server and output message     
                    if(response.type == 'error')
                    {
                        output = '<div class="error">'+response.text+'</div>';
         ...
         $("fieldset #submit_btn_4").click(function() { 
           ...
           //$.fancybox("#hidden_pix_4");
            ...
            if(proceed) 
            {
                ...
                //Ajax post data to server
                $.post('pix_mail/contact_me_4.html', post_data, function(response){  
                    //load json data from server and output message     
                    if(response.type == 'error')
                    {
                        output = '<div class="error">'+response.text+'</div>';
         ...
         $("fieldset #submit_btn_6").click(function() { 
           ...
           //$.fancybox("#hidden_pix_6");
            ...
            if(proceed) 
            {
                ...
                $.post('pix_mail/contact_me_6.html', post_data, function(response){  
                    //load json data from server and output message     
                    if(response.type == 'error')
                    {
                        output = '<div class="error">'+response.text+'</div>';
         ...
         $("fieldset #submit_btn_7").click(function() { 
           ...
           //$.fancybox("#hidden_pix_7");
            ...
            if(proceed) 
            {
                ...
                $.post('pix_mail/contact_me_7.html', post_data, function(response){  
                    //load json data from server and output message     
                    if(response.type == 'error')
                    {
                        output = '<div class="error">'+response.text+'</div>';
         ...
         $("fieldset #submit_btn_8").click(function() { 
           ...
           //$.fancybox("#hidden_pix_8");
            ...
            if(proceed) 
            {
                ...
                //Ajax post data to server
                $.post('pix_mail/contact_me_8.html', post_data, function(response){  
                    //load json data from server and output message     
                    if(response.type == 'error')
                    {
                        output = '<div class="error">'+response.text+'</div>';
        ...
        $("fieldset #subscribe_btn_10").click(function() { 
           ...
           // var user_message    = $('.pixfort_business_10 textarea[name=message]').val();
            ...
            if(proceed) 
            {
                ...
                post_data = {'user_name':user_name, 'user_number':user_number, 'user_email':user_email };
                //Ajax post data to server
                $.post('pix_mail/contact_me_10.html', post_data, function(response){  
                    //load json data from server and output message     
                    if(response.type == 'error')
                    {
                        output = '<div class="error">'+response.text+'</div>';
        ...
        $("fieldset #subscribe_btn_11").click(function() { 
           ...
           // var user_message    = $('.pixfort_form_11 textarea[name=message]').val();
            ...
            if(proceed) 
            {
                ...
                post_data = {'user_name':user_name, 'user_number':user_number, 'user_email':user_email };
                //Ajax post data to server
                $.post('pix_mail/contact_me_11.html', post_data, function(response){  
                    //load json data from server and output message     
                    if(response.type == 'error')
                    {
                        output = '<div class="error">'+response.text+'</div>';
        ...
        $("fieldset #subscribe_btn_12").click(function() { 
            ...
            if(proceed) 
            {
                ...
                post_data = {'userEmail':user_email};
                //Ajax post data to server
                $.post('pix_mail/contact_me_12.html', post_data, function(response){  
         ...
         $("fieldset #submit_btn_13").click(function() { 
           ...
           // var user_message    = $('.pixfort_gym_13 textarea[name=message]').val();
            ...
            if(proceed) 
            {
                ...
                $.post('pix_mail/contact_me_13.html', post_data, function(response){  
                    //load json data from server and output message     
                    if(response.type == 'error')
                    {
                        output = '<div class="error">'+response.text+'</div>';
       ...
       //    $.fancybox("#hidden_pix_15");
            ...
            if(proceed) 
            {
                ...
                $.post('pix_mail/contact_me_15.html', post_data, function(response){  
                    //load json data from server and output message     
                    if(response.type == 'error')
                    {
                        output = '<div class="error">'+response.text+'</div>';
        ...
        $("fieldset #subscribe_btn_19").click(function() { 
           ...
           // $.fancybox("#hidden_pix_19");
            ...
            if(proceed) 
            {
                ...
                post_data = {'userEmail':user_email};
                //Ajax post data to server
                $.post('pix_mail/contact_me_19.html', post_data, function(response){  
