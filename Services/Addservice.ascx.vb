...
Partial Class Services_Addservice
    ...
    Sub dbdetail()
        Try
            ...
            txthidden.Text = bll.buildConnectString(Me.drpdatabase.SelectedValue.Trim)
        Catch ex As Exception
    ...
    Protected Sub btntest_Click(sender As Object, e As System.EventArgs) Handles btntest.Click
        Try
            If Me.txtserver.Text = Nothing Then
                smartobj.alertwindow(Me.Page, "Please put in Server Name", "AlertZ")
                Me.txtserver.Focus()
                Exit Sub
            End If
            If Me.txtusername.Text = Nothing Then
                smartobj.alertwindow(Me.Page, "Please put in Server Username", "AlertZ")
                Me.txtusername.Focus()
                Exit Sub
            End If
            If Me.txtpassword.Text = Nothing Then
                smartobj.alertwindow(Me.Page, "Please put in Server Password", "AlertZ")
                txtpassword.Focus()
                Exit Sub
            End If
            If Me.txtdatase.Text = Nothing Then
                smartobj.alertwindow(Me.Page, "Please put in Database Name", "AlertZ")
                txtdatase.Focus()
                Exit Sub
            End If
            Dim msg As String = ""
            If Me.drpdatabase.SelectedValue = 1 Then
                msg = bll.ConnectMSSQL(txthidden.Text)
    ...
    Sub process_sqlparameter()
        Using myConnection As New SqlConnection
            myConnection.ConnectionString = txthidden.Text
            Dim myCommand As New SqlCommand
            myCommand.Connection = myConnection
            myCommand.CommandText = txt_childprocedure.Text.Trim
    ...
    Sub dbdetail2()
        Try
            ...
            txthidden.Text = bll.buildConnectString2
        Catch ex As Exception
    ...
    Sub detail()
        Try
            ...
            Dim seldetail As String = "exec proc_selServicetypeid '" & Me.txtdesc.Text.Trim & "'"
