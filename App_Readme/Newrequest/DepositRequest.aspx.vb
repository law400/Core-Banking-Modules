...
Partial Class DepositRequest
    ...
    Sub BindToGrid()
        Try
            ...
            Dim Item As String = "select B.Id,a.Employeeid,Employeename,RequestAmount,Createdate,ApproveDate, b.Status from Memcos_Reg_table   A , tbl_Normalcontribution   B  where A.Email= B.Email"
    ...
    Protected Sub RadGrid1_ItemCommand(ByVal source As Object, ByVal e As Telerik.Web.UI.GridCommandEventArgs) Handles RadGrid1.ItemCommand
        ...
        If e.CommandName = "SelectData" Then
            ...
            Dim bindreg As String = "select a.Id,a.Employeeid,Employeename,RequestAmount,Createdate,ApproveDate, a.Status from tbl_Normalcontribution a, Memcos_Reg_table b  where a.ID = '" & RevID & "' and a.Email =b.Email"
        ...
        If e.CommandName = "Delete" Then
            ...
            Dim deleteQuery As String = "DELETE from tbl_Normalcontribution where Id='" & RevID & "'"
    ...
    Protected Sub AddItem_Click(sender As Object, e As EventArgs) Handles AddItem.Click
        Try
            ...
            Dim LoanReq As String = "select * from tbl_Normalcontribution where id = '" & LblID.Text & "'"
            ...
            If Profile.Roleid = 1 And getstatus = "Not Approve" Then
                Dim UpadteRecord As String = "Update tbl_Normalcontribution set status ='Verified'  where Id=  '" & LblID.Text & "'"
                con.SqlDs(UpadteRecord)
                Panel1.Visible = True
                Panel2.Visible = False
                Label_error.Visible = False
                Label_success.Visible = True
                Label_success.Text = "This request Verification completed"
                BindToGrid()
                Exit Sub
            ...
            If Profile.Roleid = 2 And getstatus = "Verified" Then
                ...
                Dim UpadteRecord As String = "Update tbl_Normalcontribution set status ='Approved'  where Id=  '" & LblID.Text & "' "
                con.SqlDs(UpadteRecord)
                BindToGrid()
            ...
            Dim findifupdated As String = "select status from tbl_Normalcontribution where status ='Approved' and Id=  '" & LblID.Text & "'"
    ...
    Sub SendEmail()
        Try
            ...
            msg.Subject = "Deposit Request Approval"
    ...
    Protected Sub ButCancel_Click(sender As Object, e As EventArgs) Handles ButCancel.Click
        ...
        Try
            ...
            Dim Req As String = "select * from tbl_Normalcontribution where id = '" & LblID.Text & "'"
            ...
            Dim UpadteRecord As String = "Update tbl_Normalcontribution set status ='Rejected'  where Id=  '" & LblID.Text & "' "
            con.SqlDs(UpadteRecord)


            Dim findifupdated As String = "select status from tbl_Normalcontribution where status ='Rejected' and Id=  '" & LblID.Text & "'"
            If con.SqlDs(findifupdated).Tables(0).Rows.Count > 0 Then
