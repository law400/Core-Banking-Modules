<%@ Page Title="" Language="VB" MasterPageFile="~/PrimeApp.master" AutoEventWireup="false" CodeFile="ContributionReschedule.aspx.vb" Inherits="Admin_ContributionReschedule" %>
            ...
            <MasterTableView EditMode="InPlace" CssClass="table table-striped table-hover"  DataKeyNames="ID"
                ...
                <ExpandCollapseColumn FilterControlAltText="Filter ExpandColumn column">
                  ...
                  <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="OldAmount" EmptyDataText="-" HeaderText="OLd Amount (N)" 
                        UniqueName="column3" DataFormatString="{0:###,##0.00}">
                        <HeaderStyle Font-Bold="True" />
                    </telerik:GridBoundColumn>

                 <telerik:GridBoundColumn DataField="NewAmount" EmptyDataText="-" HeaderText=" New Amount (N)" 
                        UniqueName="column3" DataFormatString="{0:###,##0.00}">
                        <HeaderStyle Font-Bold="True" />
                    </telerik:GridBoundColumn>

                    <telerik:GridBoundColumn DataField="neweffectivedate" EmptyDataText="-" HeaderText="Start Date" 
                        UniqueName="column4" >
                        <HeaderStyle Font-Bold="True" />
                    </telerik:GridBoundColumn>
