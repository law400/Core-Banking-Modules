...
Partial Class Admin_ProjectFinance
    ...
    Sub BindToGrid()
        Try
            ...
            Item = "select * from tbl_M_ProjectFinance a ,tbl_bankproduct b  ,Tbl_guarantorsetup c ,Memcos_Reg_table d where a.productcode = b.ProductCode and a.productcode = c.ProductCode and  b.productcode = c.ProductCode and d.EmployeeID = a.Employeeid"
    ...
    Protected Sub RadGrid1_ItemCommand(ByVal source As Object, ByVal e As Telerik.Web.UI.GridCommandEventArgs) Handles RadGrid1.ItemCommand
        ...
        If e.CommandName = "SelectData" Then
            ...
            Dim bindreg As String = "select * from tbl_M_ProjectFinance a, Memcos_Reg_table b  where a.ID = '" & RevID & "' and a.Employeeid =b.Employeeid"
        ...
        If e.CommandName = "Delete" Then
            ...
            Dim deleteQuery As String = "DELETE from tbl_M_ProjectFinance where Id='" & RevID & "'"
    ...
    Protected Sub AddItem_Click(sender As Object, e As EventArgs) Handles AddItem.Click
        Try
            ...
            Dim LoanReq As String = "select * from tbl_M_ProjectFinance where id = '" & LblID.Text & "'"
            ...
            If Profile.Roleid = 1 And getstatus = "Not Approve" Then
                Dim UpadteRecord As String = "Update tbl_M_ProjectFinance set status ='Verified'  where Id=  '" & LblID.Text & "'"
            ...
            If Profile.Roleid = 2 And getstatus = "Verified" Then
                Dim UpadteRecord As String = "Update tbl_M_ProjectFinance set status ='Approved'  where Id=  '" & LblID.Text & "' "
                con.SqlDs(UpadteRecord)
                BindToGrid()
            Else
                Panel2.Visible = True
            ...
            Dim findifupdated As String = "select status from tbl_M_ProjectFinance where status ='Approved' and Id=  '" & LblID.Text & "'"
    ...
    Sub SendEmail()
        Try
            ...
            msg.Subject = "Project Finance Request Approval"
    ...
    Sub RejectSendEmail()
        Try
            ...
            msg.Subject = "Project Finance Loan Request Approval"
    ...
    Protected Sub ButCancel_Click(sender As Object, e As EventArgs) Handles ButCancel.Click
        ...
        Try
            ...
            Dim Req As String = "select * from tbl_M_ProjectFinance where id = '" & LblID.Text & "'"
            ...
            Dim UpadteRecord As String = "Update tbl_M_ProjectFinance set status ='Rejected'  where Id=  '" & LblID.Text & "' "
            con.SqlDs(UpadteRecord)


            Dim findifupdated As String = "select status from tbl_M_ProjectFinance where status ='Rejected' and Id=  '" & LblID.Text & "'"
            If con.SqlDs(findifupdated).Tables(0).Rows.Count > 0 Then
