...
Imports System.IO
Partial Class Admin_ContributionReschedule
    ...
    Sub BindToGrid()
        Try
            ...
            Dim Item As String = "select * from tbl_reshedulesavings"
    ...
    Protected Sub RadGrid1_ItemCommand(ByVal source As Object, ByVal e As Telerik.Web.UI.GridCommandEventArgs) Handles RadGrid1.ItemCommand
        ...
        If e.CommandName = "SelectData" Then
            ...
            Dim bindreg As String = "select a.ID,a.Employeeid,b.Employeename, a.Status from tbl_reshedulesavings a, Memcos_Reg_table b  where a.ID = '" & RevID & "' and a.Employeeid =b.Employeeid"
        ...
        If e.CommandName = "Delete" Then
            ...
            Dim deleteQuery As String = "DELETE from tbl_reshedulesavings where Id='" & RevID & "'"
    ...
    Protected Sub AddItem_Click(sender As Object, e As EventArgs) Handles AddItem.Click
        Try
            ...
            Dim LoanReq As String = "select * from tbl_reshedulesavings where id = '" & LblID.Text & "'"
            ...
            If Profile.Roleid = 1 And getstatus = "Not Approve" Then
                Dim UpadteRecord As String = "Update tbl_reshedulesavings set status ='Verified'  where Id=  '" & LblID.Text & "'"
            ...
            If Profile.Roleid = 2 And getstatus = "Verified" Then
                ...
                Dim UpadteRecord As String = "Update tbl_reshedulesavings set status ='Approved'  where Id=  '" & LblID.Text & "' "
                con.SqlDs(UpadteRecord)
                BindToGrid()
            ...
            Dim findifupdated As String = "select status from tbl_reshedulesavings where status ='Approved' and Id=  '" & LblID.Text & "'"
    ...
    Sub SendEmail()
        Try
            ...
            msg.Subject = "Items Request Approval"
    ...
    Protected Sub ButCancel_Click(sender As Object, e As EventArgs) Handles ButCancel.Click
        ...
        Try
            ...
            Dim Req As String = "select * from tbl_reshedulesavings where id = '" & LblID.Text & "'"
            ...
            Dim UpadteRecord As String = "Update tbl_reshedulesavings set status ='Rejected'  where Id=  '" & LblID.Text & "' "
            con.SqlDs(UpadteRecord)


            Dim findifupdated As String = "select status from tbl_reshedulesavings where status ='Rejected' and Id=  '" & LblID.Text & "'"
            If con.SqlDs(findifupdated).Tables(0).Rows.Count > 0 Then
