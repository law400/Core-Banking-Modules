...
Imports System.IO
Partial Class Admin_ItemRequestApproval
    ...
    Sub BindToGrid()
        Try
            ...
            Dim Item As String = "select * from Memcos_Reg_table   A , Tbl_ItemRequest   B  where A.EmployeeID= B.Employeeid"
    ...
    Protected Sub RadGrid1_ItemCommand(ByVal source As Object, ByVal e As Telerik.Web.UI.GridCommandEventArgs) Handles RadGrid1.ItemCommand
        ...
        If e.CommandName = "SelectData" Then
            ...
            Dim bindreg As String = "select * from Tbl_ItemRequest a, Memcos_Reg_table b  where a.ID = '" & RevID & "' and a.Employeeid =b.Employeeid"
        ...
        If e.CommandName = "Delete" Then
            ...
            Dim deleteQuery As String = "DELETE from Tbl_ItemRequest where Id='" & RevID & "'"
    ...
    Protected Sub AddItem_Click(sender As Object, e As EventArgs) Handles AddItem.Click
        Try
            ...
            Dim LoanReq As String = "select * from Tbl_ItemRequest where id = '" & LblID.Text & "'"
            ...
            Dim UpadteRecord As String = "Update Tbl_ItemRequest set status ='Approved'  where Id=  '" & LblID.Text & "' "
            con.SqlDs(UpadteRecord)


            Dim findifupdated As String = "select status from Tbl_ItemRequest where status ='Approved' and Id=  '" & LblID.Text & "'"
    ...
    Protected Sub ButCancel_Click(sender As Object, e As EventArgs) Handles ButCancel.Click
        ...
        Try
            ...
            Dim Req As String = "select * from Tbl_ItemRequest where id = '" & LblID.Text & "'"
            ...
            Dim UpadteRecord As String = "Update Tbl_ItemRequest set status ='Rejected'  where Id=  '" & LblID.Text & "' "
            con.SqlDs(UpadteRecord)


            Dim findifupdated As String = "select status from Tbl_ItemRequest where status ='Rejected' and Id=  '" & LblID.Text & "'"
            If con.SqlDs(findifupdated).Tables(0).Rows.Count > 0 Then
