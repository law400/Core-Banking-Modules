...
Partial Class PayFee
    ...
    Dim logger As ILog = log4net.LogManager.GetLogger(GetType(PayFee))
       ...
       & vbNewLine & "            paymentDate : '" & paymentDate & "'" _
        ...
        Try
            ...
            For Each Tablex As DataTable In DataReg.Tables
                ...
                lblTotalamount.Text = Tablex.Rows(0)("TotalAmount")
                LblAmount.Text = Tablex.Rows(0)("Amount")
                lblcharge.Text = Tablex.Rows(0)("Fee_Amt")
                lblsubamount.Text = Tablex.Rows(0)("Amount")
...
& vbNewLine & "******************************************************************************************************")
    ...
    Sub Email_successful(ByVal Nodeid As String, ByVal Password As String)
        ...
        Try
            ...
            body2 += "This is to inform you that your UCP registration was successful and has been approved.<br/>"
