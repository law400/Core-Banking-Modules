    ...
    Protected Sub Login_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Login.Click
        ...
        Try
            ...
            If Me.txtCoopID.Text = "" Then
                ...
                smartobj.alertwindow(Me.Page, "[Please Enter a Tenant ID]", "Prime")
                Exit Sub
            Else
                ...
                ElseIf retval = 0 Then
                    ...
                    Dim qrysysdate As String = "select sys_date,sys_phase from tbl_system where node_id = " & Profile.node_ID & ""
                    For Each dr As Data.DataRow In con.SqlDs(qrysysdate).Tables(0).Rows
                        Profile.sysdate = dr!sys_date
                        Profile.sysphase = dr!sys_phase
                    Next
