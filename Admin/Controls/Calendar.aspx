<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Calendar.aspx.cs" Inherits="Controls_Calendar" %>
    ...
    <table height="220" cellSpacing="0" cellPadding="0" width="100%" border="0">
					...
					<td>
						<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								...
								<td vAlign="middle" align="right" width="45%"><asp:dropdownlist id="CboMonth" runat="server" Width="60px" CssClass="cssDTPComboBox" AutoPostBack="True" OnSelectedIndexChanged="CboMonth_SelectedIndexChanged">
				...
				<tr height="170">
					<td vAlign="top" align="center"><asp:calendar id="CdrDatePicker" runat="server" ToolTip="Select Date" Width="240px" CssClass="cssDatePickerBase"
							ShowNextPrevMonth="False" FirstDayOfWeek="Sunday" NextMonthText=" " PrevMonthText=" " Height="170px" DayNameFormat="FirstLetter" OnSelectionChanged="CdrDatePicker_SelectionChanged">
