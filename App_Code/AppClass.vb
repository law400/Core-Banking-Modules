...
Public Class AppClass
    ...
    Public Shared Sub BootstrapAlert(MsgLabel As System.Web.UI.WebControls.Label, Message As String, Optional MessageType As BootstrapAlertType = BootstrapAlertType.Plain, Optional Dismissable As Boolean = False)
        Dim style As String = "", icon As String = ""
