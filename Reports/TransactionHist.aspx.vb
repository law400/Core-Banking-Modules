...
Partial Class Reports_TransactionHist
    Inherits SessionCheck
    Dim logger As ILog = log4net.LogManager.GetLogger(GetType(Reports_TransactionHist))
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            Dim aa As String = "select UniqueID,accountnumber,narration,trandate,valuedate,tranAmount from tbl_transactions where node_id  = '" & Session("node_ID") & "' "
