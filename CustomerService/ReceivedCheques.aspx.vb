...
Partial Class CustomerService_ReceivedCheques
    ...
    End Sub
    Sub bind2()
        Dim selBind As String = "exec proc_chqissueddetail"
    ...
    Protected Sub Btnsubmit2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btnsubmit2.Click
        ...
        For Each gv As GridViewRow In GridView2.Rows
            ...
            If selectedChkBxItem.Checked Then
                ...
                If chkBox Then
                    Try
                        Dim updMicr As String = "Update tbl_CheqRequest set status=5,issueddate='" & latesttime & "' where accountnumber='" & gvIDs & "'"
                        con.SqlDs(updMicr)
        ...
        smartobj.alertwindow(Me.Page, "Cheque Issued to Customer", "Prime")
