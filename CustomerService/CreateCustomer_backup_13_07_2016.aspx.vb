...
Partial Class CustomerService_CreateCustomer
    ...
    Dim logger As ILog = log4net.LogManager.GetLogger(GetType(CustomerService_CreateCustomer))
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            Catch ex As Exception
                ...
                logger.Info("CUSTOMER SERVICE: CreateCustomer Page_Load" _
...
#Region "Task"
    ...
    Protected Sub BtnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btnsubmit.Click
        ...
        Catch ex As Exception
            ...
            logger.Info("CUSTOMER SERVICE: CreateCustomer BtnSubmit_Click" _
  & vbNewLine & "   <<<<Direction: OUTPUT" _
  & vbNewLine & "      OUTPUT PARAMETERS LIST & " _
  & vbNewLine & "           ERROR MESSAGE: '" & ex.Message & "'" _
  & vbNewLine & "       OUTPUT PARAMETERS LIST END----------'" _
  & vbNewLine & "******************************************************************************************************")
    ...
    Protected Sub BtnSubmit2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnSubmit2.Click
        ...
        Catch ex As Exception
            logger.Info("CUSTOMER SERVICE: CreateCustomer BtnSubmit2_Click" _
 & vbNewLine & "   <<<<Direction: OUTPUT" _
 & vbNewLine & "      OUTPUT PARAMETERS LIST & " _
 & vbNewLine & "           ERROR MESSAGE: '" & ex.Message & "'" _
 & vbNewLine & "       OUTPUT PARAMETERS LIST END----------'" _
 & vbNewLine & "******************************************************************************************************")
    ...
    Protected Sub txtcustid_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtcustid.TextChanged
        ...
        Catch ex As Exception
            ...
            logger.Info("CUSTOMER SERVICE: CreateCustomer txtcustid_TextChanged" _
  & vbNewLine & "   <<<<Direction: OUTPUT" _
  & vbNewLine & "      OUTPUT PARAMETERS LIST & " _
  & vbNewLine & "           ERROR MESSAGE: '" & ex.Message & "'" _
  & vbNewLine & "       OUTPUT PARAMETERS LIST END----------'" _
...
#End Region
    ...
    Protected Sub txtsignacct_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtsignacct.TextChanged
        ...
        Catch ex As Exception
            ...
            logger.Info("CUSTOMER SERVICE: CreateCustomer txtsignacct_TextChanged" _
& vbNewLine & "   <<<<Direction: OUTPUT" _
& vbNewLine & "      OUTPUT PARAMETERS LIST & " _
& vbNewLine & "           ERROR MESSAGE: '" & ex.Message & "'" _
& vbNewLine & "       OUTPUT PARAMETERS LIST END----------'" _
