...
Partial Class CustomerService_Hotlist
    ...
    Dim qry As String = ""
    Dim logger As ILog = log4net.LogManager.GetLogger(GetType(CustomerService_Hotlist))
    Protected Sub Btnsubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btnsubmit.Click
        ...
        Try
            ...
            If Me.RDBHotList.SelectedValue = "2" Then
                strval = "Declare @retval int,@retmsg varchar(100) Exec Proc_addHotList '" & Me.txtAcctNo3.Text.Trim.Replace("'", " ") & "'," &
                          "'" & Format(CDate(latesttime), "MM/dd/yyyy hh:mm:ss") & "','" & Me.txtStart2.Text.Trim.Replace("'", " ") & "'," &
        ...
        Catch ex As Exception
            logger.Info("CUSTOMER SERVICE: HOTLIST BtnSubmit_Click" _
...
& vbNewLine & "******************************************************************************************************")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        hypAccount.NavigateUrl = "javascript:accountPicker('document.aspnetForm." + txtAcctNo3.ClientID.ToString() + "');"
    ...
    Sub search()
        Try
            ...
            End If
        Catch ex As Exception
            logger.Info("CUSTOMER SERVICE: HOTLIST Sub Search" _
& vbNewLine & "   <<<<Direction: OUTPUT" _
& vbNewLine & "      OUTPUT PARAMETERS LIST & " _
& vbNewLine & "           ERROR MESSAGE: '" & ex.Message & "'" _
& vbNewLine & "       OUTPUT PARAMETERS LIST END----------'" _
