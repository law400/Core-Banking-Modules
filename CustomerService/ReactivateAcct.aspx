<%@ Page Language="VB" MasterPageFile="~/PrimeApp.master" AutoEventWireup="false" CodeFile="ReactivateAcct.aspx.vb" Inherits="CustomerService_ReactivateAcct" title="Untitled Page" %>
...
<div class="box-body">
    <div class="row">
        ...
        <div class="form-group">
         ...
         <div class="col-md-6" style=" top: 0px; left: 10px; width:400px; height:400px">
                           <div class="form-group"> 
                                    Account Number*
                            ...
                            <div class="form-group" >
                                    Narration
									<asp:TextBox ID="txtNaration" runat="server" CssClass="form-control" Height="100px" TabIndex="5" TextMode="MultiLine"></asp:TextBox>
                            </div>
                        </div>

        
        
       <div class="col-md-6" style="background-color: #ccccff; width:400px; height:500px">
                           <div class="form-group" style="font-size: small; background-color: #FF9E0D"> 
                            ...
                            <div class="form-group" >
                                    <span style="color: #000000">Branch:<strong>&nbsp;</strong></span>
                                    <asp:Label ID="Label3" runat="server" ForeColor="Black" Width="200px"></asp:Label>
                            </div>
                            <div class="form-group" >
                           
                                    <span style="color: black">Book Balance:</span><strong style="font-weight: bold; color: black">&nbsp;</strong>
                                    <asp:Label ID="Label4" runat="server" ForeColor="Black" Width="125px"></asp:Label>
                             
                            </div>
                            <div class="form-group" >
                          
                                    <span style="color: black">Effective Balance:&nbsp;</span>
                                    <asp:Label ID="Label5" runat="server" ForeColor="Black" Width="126px"></asp:Label>
                             
                            </div>
                            <div class="form-group" >
                          
                                    <span style="color: black">Usable Balance:</span><b style="font-weight: normal"></b>
                                    </b>
                                    ...
                                    <table style="width: 371px">
                                        ...
                                        <tr class="row-b" style="color: #0000ff">
                                            <td class="first" style="width: 136px">
                                                Naration</td>
                                            <td style="width: 274px">
                                                <asp:TextBox ID="txtNaration" runat="server" Height="42px" TabIndex="5" TextMode="MultiLine"
