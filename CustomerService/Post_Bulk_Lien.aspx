<%@ Page Language="VB" MasterPageFile="~/PrimeApp.master" AutoEventWireup="false" CodeFile="Post_Bulk_Lien.aspx.vb" Inherits="CustomerService_Post_Bulk_Lien" title="Untitled Page" %>
...
<div class="post boxed">
            ...
            <td style="height: 22px;" colspan="3">
                ...
                <tr>
                    <td colspan="3" style="height: 22px;">
                        Select Lien Type&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:DropDownList ID="DrpLien" runat="server" Height="30px" Width="171px">
                            <asp:ListItem Value="0">--Select Lien  Type--</asp:ListItem>
                            <asp:ListItem Value="1">Lien On Balance</asp:ListItem>
                            <asp:ListItem Value="4">Lien On DR Transactions</asp:ListItem>
                            <asp:ListItem Value="5">Lien On CR Transactions</asp:ListItem>
                            <asp:ListItem Value="6">Lien On all Transaction</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                   <tr>
                    <td colspan="3" style="height: 22px;">
                        Select Lien Reason &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:DropDownList ID="DropReason" runat="server" Height="30px" Width="171px">
                            <asp:ListItem Value="NO_Value">--Select Lien Reason--</asp:ListItem>
                            <asp:ListItem Value="DY-BVN">Lien On BVN</asp:ListItem>
                            <asp:ListItem Value="DY_Other_Lien">Other Reasons </asp:ListItem>
                           </asp:DropDownList>
                    </td>
                </tr>
        <tr>
        ...
        <tr>
            ...
            ShowFooter="True" CellPadding="3" Font-Size="X-Small"
                            Width="968px" GridLines="Horizontal" BackColor="White" 
                            ...
                            <FooterStyle BackColor="#B5C7DE" ForeColor="#4A3C8C" />
                             <Columns>
                                ...
                                <asp:BoundField DataField="HoldReason" HeaderText="Hold Reason">
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                        ...
                        <asp:Panel ID="PaneValidate" runat="server" Font-Bold="True" 
                            ...
                            <asp:Label ID="LblAccountvalidate" runat="server" Font-Bold="True" 
                                Font-Size="Large" ForeColor="#FF9900" 
                                Text=" Account number(s) are invalid"></asp:Label>
                            <br />
                            ...
                            <br />
                             <asp:Label ID="LblDATE" runat="server" Font-Bold="True" Font-Size="Large" 
                                ForeColor="#FF9900" Text=" Effective and End date is Less Calender date"></asp:Label>
                            <br />


                            <asp:Label ID="LblAccountLien" runat="server" Font-Bold="True" 
                                Font-Size="Large" ForeColor="#FF9900" 
                                Text=" Lien  already exist for this account"></asp:Label>
                            <br />
                            <br />
                            <br />
                        </asp:Panel>
