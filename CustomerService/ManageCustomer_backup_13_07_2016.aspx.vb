    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            Catch ex As Exception
                logger.Info("CUSTOMER SERVICE: ManageCustomer Page_Load" _
    ...
    Protected Sub BtnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btnsubmit.Click
        Try
            ...
            If Profile.Custtype = "1" Then
                ...
                qry = qry & smartobj.EncoteWithSingleQuote(Profile.Userid.Trim) & ","
                qry = qry & smartobj.EncoteWithSingleQuote(Profile.EventLogID) & ","
                qry = qry & smartobj.EncoteWithSingleQuote(smartobj.DecodeCkeckBox(Me.chkStaffType)) & ","
                qry = qry & smartobj.EncoteWithSingleQuote(Me.txtOfficer.Text.Trim) & ",@retVal OUTPUT,@retmsg OUTPUT "
        ...
        Catch ex As Exception
            logger.Info("CUSTOMER SERVICE: ManageCustomer BtnSubmit_Click" _
& vbNewLine & "   <<<<Direction: OUTPUT" _
& vbNewLine & "      OUTPUT PARAMETERS LIST & " _
& vbNewLine & "           ERROR MESSAGE: '" & ex.Message & "'" _
& vbNewLine & "       OUTPUT PARAMETERS LIST END----------'" _
& vbNewLine & "******************************************************************************************************")
    ...
    Protected Sub txtIntroID_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtIntroID.TextChanged
        ...
        Catch ex As Exception
            ...
            logger.Info("CUSTOMER SERVICE: ManageCustomer txtIntroID_TextChanged" _
& vbNewLine & "   <<<<Direction: OUTPUT" _
& vbNewLine & "      OUTPUT PARAMETERS LIST & " _
& vbNewLine & "           ERROR MESSAGE: '" & ex.Message & "'" _
& vbNewLine & "       OUTPUT PARAMETERS LIST END----------'" _
& vbNewLine & "******************************************************************************************************")
    ...
    Protected Sub txtOfficer_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtOfficer.TextChanged
        Try
            ...
            End If
        Catch ex As Exception
            logger.Info("CUSTOMER SERVICE: ManageCustomer txtOfficer_TextChanged" _
& vbNewLine & "   <<<<Direction: OUTPUT" _
& vbNewLine & "      OUTPUT PARAMETERS LIST & " _
& vbNewLine & "           ERROR MESSAGE: '" & ex.Message & "'" _
& vbNewLine & "       OUTPUT PARAMETERS LIST END----------'" _
    ...
    Protected Sub txtCompintro_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCompintro.TextChanged
        Try
            ...
            If Me.drpintro2.SelectedValue = "2" Then
                ...
                End If
            Else
                Dim selcust As String = "Select fullname from tbl_userprofile where userid='" & Me.txtCompintro.Text & "'"
                If con.SqlDs(selcust).Tables(0).Rows.Count > 0 Then
                    For Each dr As Data.DataRow In con.SqlDs(selcust).Tables(0).Rows
            ...
            End If
        Catch ex As Exception
            logger.Info("CUSTOMER SERVICE: ManageCustomer txtCompintro_TextChanged" _
& vbNewLine & "   <<<<Direction: OUTPUT" _
& vbNewLine & "      OUTPUT PARAMETERS LIST & " _
& vbNewLine & "           ERROR MESSAGE: '" & ex.Message & "'" _
& vbNewLine & "       OUTPUT PARAMETERS LIST END----------'" _
& vbNewLine & "******************************************************************************************************")
    ...
    Protected Sub txtCompOffc_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCompOffc.TextChanged
        Try
            Dim selcust As String = "Select fullname from tbl_userprofile where userid='" & Me.txtCompOffc.Text & "'"
            If con.SqlDs(selcust).Tables(0).Rows.Count > 0 Then
                For Each dr As Data.DataRow In con.SqlDs(selcust).Tables(0).Rows
            ...
            End If
        Catch ex As Exception
            logger.Info("CUSTOMER SERVICE: ManageCustomer txtCompOffc_TextChanged" _
& vbNewLine & "   <<<<Direction: OUTPUT" _
& vbNewLine & "      OUTPUT PARAMETERS LIST & " _
& vbNewLine & "           ERROR MESSAGE: '" & ex.Message & "'" _
& vbNewLine & "       OUTPUT PARAMETERS LIST END----------'" _
& vbNewLine & "******************************************************************************************************")
    ...
    Sub search()
        ...
        Catch ex As Exception
            logger.Info("CUSTOMER SERVICE: ManageCustomer  Sub search" _
& vbNewLine & "   <<<<Direction: OUTPUT" _
& vbNewLine & "      OUTPUT PARAMETERS LIST & " _
& vbNewLine & "           ERROR MESSAGE: '" & ex.Message & "'" _
& vbNewLine & "       OUTPUT PARAMETERS LIST END----------'" _
& vbNewLine & "******************************************************************************************************")
    ...
    Protected Sub txtCustomerid_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCustomerid.TextChanged
        ...
        Catch ex As Exception
            logger.Info("CUSTOMER SERVICE: ManageCustomer  txtCustomerid_TextChanged" _
& vbNewLine & "   <<<<Direction: OUTPUT" _
& vbNewLine & "      OUTPUT PARAMETERS LIST & " _
& vbNewLine & "           ERROR MESSAGE: '" & ex.Message & "'" _
& vbNewLine & "       OUTPUT PARAMETERS LIST END----------'" _
...
#End Region
    ...
    Protected Sub txtsignacct_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtsignacct.TextChanged
        ...
        Catch ex As Exception
            ...
            logger.Info("CUSTOMER SERVICE: ManageCustomer  txtsignacct_TextChanged" _
& vbNewLine & "   <<<<Direction: OUTPUT" _
& vbNewLine & "      OUTPUT PARAMETERS LIST & " _
& vbNewLine & "           ERROR MESSAGE: '" & ex.Message & "'" _
& vbNewLine & "       OUTPUT PARAMETERS LIST END----------'" _
& vbNewLine & "******************************************************************************************************")
    ...
    Protected Sub BtnSubmit2_Click(sender As Object, e As EventArgs) Handles BtnSubmit2.Click
        ...
        Catch ex As Exception
            logger.Info("CUSTOMER SERVICE: ManageCustomer  BtnSubmit2_Click" _
& vbNewLine & "   <<<<Direction: OUTPUT" _
& vbNewLine & "      OUTPUT PARAMETERS LIST & " _
& vbNewLine & "           ERROR MESSAGE: '" & ex.Message & "'" _
& vbNewLine & "       OUTPUT PARAMETERS LIST END----------'" _
& vbNewLine & "******************************************************************************************************")
    ...
    Protected Sub But_Reset2_Click(sender As Object, e As EventArgs) Handles But_Reset2.Click
        clear2()
    End Sub
End Class
