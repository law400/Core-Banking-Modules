...
Partial Class CustomerService_AccountHold
    ...
    Protected Sub Btnsubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnSubmit.Click
        Try
            ...
            ' Dim userid As String = Profile.userid.ToString
    ...
    Sub reset()
        ...
        Else
            ...
            If Me.Txtaccountnumber.Text = "" Then
                Exit Sub
            End If
            Dim seltyp As String = "Select accounttitle,* from tbl_holdtrans a,tbl_casaaccount b where a.accountnumber='" & Me.Txtaccountnumber.Text.Trim & "' and a.status=1 and a.accountnumber=b.accountnumber"
    ...
    Sub detail()
        ...
        Dim seltyp As String = "Select accountnumber,accounttitle,apptype,isnull(a.lien,0) lien from tbl_bankproduct a,tbl_casaaccount b where a.productcode=b.productcode and b.accountnumber='" & Me.Txtaccountnumber.Text.Trim & "'"
        If con.SqlDs(seltyp).Tables(0).Rows.Count > 0 Then
            Dim lien As String = ""
            For Each dr As Data.DataRow In con.SqlDs(seltyp).Tables(0).Rows
                Me.txtAccountName.Text = dr!accounttitle.ToString.Trim
            ...
            If lien = "0" Then
                ...
                Exit Sub
            End If
            Dim selacct As String = "select count(1) from tbl_holdTrans where accountnumber='" & Me.Txtaccountnumber.Text.Trim & "'"
    ...
    Protected Sub DrpSerial_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DrpSerial.SelectedIndexChanged
        Try
            Dim seltyp As String = "Select * from tbl_holdtrans where accountnumber='" & Me.Txtaccountnumber.Text.Trim & "' and status=1 and holdnumber='" & Me.DrpSerial.SelectedValue.Trim & "'"
            Dim dr2 As Data.DataRow
