...
Public Class Handler2 : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Try
            ...
            dr.Read()
            context.Response.ContentType = dr("Image_Type2").ToString()
            If Not IsDBNull(dr.Item("signatureimage")) Then
                context.Response.BinaryWrite(CType(dr.Item("signatureimage"), Byte()))
            End If
