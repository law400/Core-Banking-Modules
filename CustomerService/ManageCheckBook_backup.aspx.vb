...
Partial Class CustomerService_ManageCheckBook
    ...
    Sub refgrid()
        ...
        Else
            ...
            Me.txtEnd.Text = CInt(Profile.chkno) + CInt(Me.txtStart.Text)
    ...
    Protected Sub Btnsubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btnsubmit.Click
        ...
        '    chk = 0
        'End If
        latesttime = System.DateTime.Parse(Profile.sysdate)
        ...
        Dim insacc As String = "Declare @retval int,@retmsg varchar(200) exec Proc_PostCheque '" & Me.txtAcctNo1.Text.Trim & "','" & CDec(Me.txtcost.Text.Trim) & "','" & CDec(Me.txttotcost.Text.Trim) & "'," & _
   "'" & Me.DrpBranch2.SelectedValue.Trim & "'," & Me.txtstart.Text.Trim & "," & Me.txtend.Text.Trim & ",'" & Format(CDate(latesttime), "MM/dd/yyyy hh:mm:ss") & "'," & _
   "'" & Me.DrpChkType1.SelectedValue.Trim & "'," & chk & ",'" & Me.txtNarration.Text.Trim & "','" & Profile.Userid.Trim & "',NULL,@retVal Output,@retmsg Output select @retval ,@retmsg"
