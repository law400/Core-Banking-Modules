<%@ Page Title="" Language="VB" MasterPageFile="~/PrimeApp.master" AutoEventWireup="false" CodeFile="CreateCustomer.aspx.vb" Inherits="CreateCustomer" %>
...
<%--            <asp:Button ID="Button1" runat="server" Text="Submit" class="btn btn-primary"  Font-Bold="True" ForeColor="White" Width="100%" />--%>
       ...
       <telerik:RadAjaxLoadingPanel runat="server" ID="gridLoadingPanel"></telerik:RadAjaxLoadingPanel>
            ...
            <div class="form-group">
         <a href="#" onclick="return ShowInsertForm();" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"/>Create New Customer</a>
      <asp:LinkButton ID="Refresh" CssClass="btn btn-warning btn-sm" CommandName="Refresh" runat="server"><span class="glyphicon glyphicon-refresh"/>Refresh</asp:LinkButton>
		...
		<div class="form-group">
			<asp:TextBox ID="TxtCustSearch" runat="server" Width="419px" AutoPostBack="True" placeholder="Customer Search:"></asp:TextBox>
		 </div>
            <div>
