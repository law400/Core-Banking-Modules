<%@ Page Language="VB" MasterPageFile="~/PrimeApp.master" AutoEventWireup="false" CodeFile="DispatchCheq.aspx.vb" Inherits="CustomerService_DispatchCheq" title="Untitled Page" %>
    ...
    <table style="width: 612px">
        ...
        <tr>
            <td align="center" colspan="5" style="height: 17px">
                <asp:Button ID="Btnsubmit2" runat="server" BackColor="#C0C0FF" Text="Dispatch" Width="101px" /><asp:Button ID="BtnReturn2" runat="server" BackColor="#C0C0FF"
